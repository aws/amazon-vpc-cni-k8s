...
function up-test-cluster() {
    ...
    AWS_K8S_TESTER_EKS_NAME=$CLUSTER_NAME \
        ...
        AWS_K8S_TESTER_EKS_PARAMETERS_ROLE_ARN=arn:aws:iam::431277324525:role/bennapol-eks \
        AWS_K8S_TESTER_EKS_ADD_ON_MANAGED_NODE_GROUPS_ENABLE=true \
        AWS_K8S_TESTER_EKS_ADD_ON_MANAGED_NODE_GROUPS_ROLE_CREATE=false \
        AWS_K8S_TESTER_EKS_ADD_ON_MANAGED_NODE_GROUPS_ROLE_ARN=arn:aws:iam::431277324525:role/bennapol-eks \
