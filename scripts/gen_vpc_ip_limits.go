...
func addManualLimits(limitMap map[string]awsutils.InstanceTypeLimits) map[string]awsutils.InstanceTypeLimits {
	manuallyAddedLimits := map[string]awsutils.InstanceTypeLimits{
		...
		"m7g.medium":    {ENILimit: 2, IPv4Limit: 4, HypervisorType: "unknown", IsBareMetal: false},
		"m7g.large":     {ENILimit: 3, IPv4Limit: 10, HypervisorType: "unknown", IsBareMetal: false},
		"m7g.xlarge":    {ENILimit: 4, IPv4Limit: 15, HypervisorType: "unknown", IsBareMetal: false},
		"m7g.2xlarge":   {ENILimit: 4, IPv4Limit: 15, HypervisorType: "unknown", IsBareMetal: false},
		"m7g.4xlarge":   {ENILimit: 8, IPv4Limit: 30, HypervisorType: "unknown", IsBareMetal: false},
		"m7g.8xlarge":   {ENILimit: 8, IPv4Limit: 30, HypervisorType: "unknown", IsBareMetal: false},
		"m7g.12xlarge":  {ENILimit: 8, IPv4Limit: 30, HypervisorType: "unknown", IsBareMetal: false},
		"m7g.16xlarge":  {ENILimit: 15, IPv4Limit: 50, HypervisorType: "unknown", IsBareMetal: false},
		"m7g.metal":     {ENILimit: 15, IPv4Limit: 50, HypervisorType: "unknown", IsBareMetal: true},
		"r7g.medium":    {ENILimit: 2, IPv4Limit: 4, HypervisorType: "unknown", IsBareMetal: false},
		"r7g.large":     {ENILimit: 3, IPv4Limit: 10, HypervisorType: "unknown", IsBareMetal: false},
		"r7g.xlarge":    {ENILimit: 4, IPv4Limit: 15, HypervisorType: "unknown", IsBareMetal: false},
		"r7g.2xlarge":   {ENILimit: 4, IPv4Limit: 15, HypervisorType: "unknown", IsBareMetal: false},
		"r7g.4xlarge":   {ENILimit: 8, IPv4Limit: 30, HypervisorType: "unknown", IsBareMetal: false},
		"r7g.8xlarge":   {ENILimit: 8, IPv4Limit: 30, HypervisorType: "unknown", IsBareMetal: false},
		"r7g.12xlarge":  {ENILimit: 8, IPv4Limit: 30, HypervisorType: "unknown", IsBareMetal: false},
		"r7g.16xlarge":  {ENILimit: 15, IPv4Limit: 50, HypervisorType: "unknown", IsBareMetal: false},
		"r7g.metal":     {ENILimit: 15, IPv4Limit: 50, HypervisorType: "unknown", IsBareMetal: true},
	}
