...
// Source: github.com/aws/amazon-vpc-cni-k8s/pkg/controller/pod (interfaces: K8SAPIs)
...
import (
	...
	pod "github.com/aws/amazon-vpc-cni-k8s/pkg/controller/pod"
...
func (m *MockK8SAPIs) K8SGetLocalPodIPs() ([]*pod.K8SPodInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "K8SGetLocalPodIPs")
	ret0, _ := ret[0].([]*pod.K8SPodInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
