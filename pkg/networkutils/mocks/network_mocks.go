...
func (m *MockNetworkAPIs) GetRouteTableNumberForENI(arg0 int, arg1 string, arg2, arg3 int, arg4 bool) (int, bool, error) {
	m.ctrl.T.Helper()
...
// UpdateHostSNATRules mocks base method.
func (m *MockNetworkAPIs) UpdateHostSNATRules(arg0 []string, arg1 string, arg2 *net.IP, arg3 bool) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateHostSNATRules", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateHostSNATRules indicates an expected call of UpdateHostSNATRules.
func (mr *MockNetworkAPIsMockRecorder) UpdateHostSNATRules(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateHostSNATRules", reflect.TypeOf((*MockNetworkAPIs)(nil).UpdateHostSNATRules), arg0, arg1, arg2, arg3)
}
