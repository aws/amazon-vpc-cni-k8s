...
import (
	...
	"github.com/aws/amazon-vpc-cni-k8s/pkg/client/clientset/versioned/scheme"
...
// CrdV1alpha1Client is used to interact with features provided by the crd.k8s.amazonaws.com group.
type CrdV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CrdV1alpha1Client) ENIConfigs() ENIConfigInterface {
	return newENIConfigs(c)
}
