...
var InstanceNetworkingLimits = map[string]InstanceTypeLimits{
	...
	"c7g.12xlarge":      {ENILimit: 8, IPv4Limit: 30, HypervisorType: "nitro"},
	"c7g.16xlarge":      {ENILimit: 15, IPv4Limit: 50, HypervisorType: "nitro"},
	"c7g.2xlarge":       {ENILimit: 4, IPv4Limit: 15, HypervisorType: "nitro"},
	"c7g.4xlarge":       {ENILimit: 8, IPv4Limit: 30, HypervisorType: "nitro"},
	"c7g.8xlarge":       {ENILimit: 8, IPv4Limit: 30, HypervisorType: "nitro"},
	"c7g.large":         {ENILimit: 3, IPv4Limit: 10, HypervisorType: "nitro"},
	"c7g.medium":        {ENILimit: 2, IPv4Limit: 4, HypervisorType: "nitro"},
	"c7g.xlarge":        {ENILimit: 4, IPv4Limit: 15, HypervisorType: "nitro"},
	"c7g.metal":         {ENILimit: 15, IPv4Limit: 50, HypervisorType: ""},
