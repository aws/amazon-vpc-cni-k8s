...
| `image.overrideRepository` | A custom docker image to use (without tag)           | `nil`                               |
...
| `init.image.overrideRepository` | A custom docker image to use (without tag)      | `nil`                               |
...
| `nodeAgent.image.overrideRepository` | A custom docker image to use (without tag) | `nil`                               |
