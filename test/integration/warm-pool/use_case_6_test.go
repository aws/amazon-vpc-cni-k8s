...
// This test will scale the cluster up to maxPods with a scale amount that is randomly calculated each loop based on
// maxPods and scales the cluster back down with the same way
