...
// GetMaxAllocatableIPs mocks base method.
func (m *MockCNIBackendClient) GetMaxAllocatableIPs(arg0 context.Context, arg1 *emptypb.Empty, arg2 ...grpc.CallOption) (*rpc.GetMaxAllocatableIPsReply, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "GetMaxAllocatableIPs", varargs...)
	ret0, _ := ret[0].(*rpc.GetMaxAllocatableIPsReply)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetMaxAllocatableIPs indicates an expected call of GetMaxAllocatableIPs.
func (mr *MockCNIBackendClientMockRecorder) GetMaxAllocatableIPs(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMaxAllocatableIPs", reflect.TypeOf((*MockCNIBackendClient)(nil).GetMaxAllocatableIPs), varargs...)
}
